...
public class Vector4d implements Vectord, Comparable<Vector4d>, Serializable, Cloneable {
    ...
    public double lengthSquared(Vector4d v) {
        return lengthSquared(v.x, v.y, v.z, v.w);
    }

    public double lengthSquared(double x, double y, double z, double w) {
    ...
    public double length(Vector4d v) {
        return length(v.x, v.y, v.z, v.w);
    }

    public double length(double x, double y, double z, double w) {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(vector4.z, z) == 0;
    }
