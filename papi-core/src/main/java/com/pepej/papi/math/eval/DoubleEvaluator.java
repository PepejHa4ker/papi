...
public class DoubleEvaluator extends AbstractEvaluator<Double> {
    ...
    /**
     * Returns the square of n numbers (n&gt;=1)
     */
    public static final Function SQRT_FN = new Function("sqrt", 1);
    ...
    /**
     * The sqrt operator in the standard operator precedence.
     */
    public static final Operator SQRT_OP = new Operator("√", 1, Operator.Associativity.RIGHT, 3);
    /**
     ...
     */
    private static final Operator[] OPERATORS = new Operator[]{NEGATE, MINUS, PLUS, MULTIPLY, DIVIDE, EXPONENT, MODULO, SQRT_OP};
    /**
     ...
     */
    private static final Function[] FUNCTIONS = new Function[]{SINE, COSINE, TANGENT, ASINE, ACOSINE, ATAN, SINEH, COSINEH, TANGENTH, MIN, MAX, SUM, AVERAGE, LN, LOG, ROUND, CEIL, FLOOR, ABS, RANDOM, SQRT_FN};
    /**
    ...
    protected Double evaluate(Operator operator, Iterator<Double> operands, Object evaluationContext) {
        ...
        else if (SQRT_OP.equals(operator)) {
    ...
    protected Double evaluate(Function function, Iterator<Double> arguments, Object evaluationContext) {
        ...
        } else if (SQRT_FN.equals(function)) {
