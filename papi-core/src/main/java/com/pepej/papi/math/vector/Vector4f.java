...
public class Vector4f implements Vectorf, Comparable<Vector4f>, Serializable, Cloneable {
    ...
    public float lengthSquared(Vector4f v) {
        return lengthSquared(v.x, v.y, v.z, v.w);
    }

    public float lengthSquared(double x, double y, double z, double w) {
        return lengthSquared((float) x, (float) y, (float) z, (float) w);
    }

    public float lengthSquared(float x, float y, float z, float w) {
    ...
    public float length(Vector4f v) {
        return length(v.x, v.y, v.z, v.w);
    }

    public float length(double x, double y, double z, double w) {
        return length((float) x, (float) y, (float) z, (float) w);
    }

    public float length(float x, float y, float z, float w) {
    ...
    public boolean equals(Object o) {
        ...
        return Float.compare(vector4.z, z) == 0;
    }
