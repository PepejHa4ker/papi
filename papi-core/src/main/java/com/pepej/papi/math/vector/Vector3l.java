...
public class Vector3l implements Vectorl, Comparable<Vector3l>, Serializable, Cloneable {
    ...
    public long lengthSquared(Vector3l v) {
        return lengthSquared(v.x, v.y, v.z);
    }

    public long lengthSquared(double x, double y, double z) {
        return lengthSquared((long) x, (long) y, (long) z);
    }

    public long lengthSquared(long x, long y, long z) {
    ...
    public long length(Vector3l v) {
        return length(v.x, v.y, v.z);
    }

    public long length(double x, double y, double z) {
        return length((long) x, (long) y, (long) z);
    }

    public long length(long x, long y, long z) {
        return (long) Math.sqrt(lengthSquared(x, y, z));
    }
