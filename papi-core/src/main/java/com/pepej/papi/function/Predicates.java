...
public final class Predicates {
     ...
     */
    public static <A, B> Predicate<A> compose(Function<? super A, ? extends B> function, Predicate<B> predicate) {
     ...
     * @return a predicate
     */
    public static <A, B> Predicate<A> isNull(Function<? super A, ? extends B> composeFunction) {
     ...
     * @return a predicate
     */
    public static <A, B> Predicate<A> notNull(Function<? super A, ? extends B> composeFunction) {
     ...
     * @return a predicate
     */
    public static <A, B> Predicate<A> equalTo(Function<? super A, ? extends B> composeFunction, @Nullable Object target) {
     ...
     * @return a predicate
     */
    public static <A, B> Predicate<A> in(Function<? super A, ? extends B> composeFunction, Collection<? extends B> collection) {
     ...
     */
    @SafeVarargs
    public static <A, B> Predicate<A> in(Function<? super A, ? extends B> composeFunction, B... args) {
    ...
    private enum ObjectPredicate implements Predicate<Object> {
        ALWAYS_TRUE {
            ...
            @Override
            @NonNull
            public Predicate<? super Object> and(@NonNull Predicate<? super Object> other) {
                return other;
            }

            @Override
            @NonNull
            public Predicate<? super Object> or(@NonNull Predicate<? super Object> other) {
                return this;
           }

            @Override
            @NonNull
            public Predicate<? super Object> negate() {
                return ALWAYS_FALSE;
            }
        },
        ALWAYS_FALSE {
