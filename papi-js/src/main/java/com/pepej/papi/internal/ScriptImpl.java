...
import com.pepej.papi.environment.loader.DelegateScriptLoader;
import com.pepej.papi.environment.loader.ScriptLoader;
...
class ScriptImpl implements Script, Runnable {
    ...
    private final CompositeTerminable compositeAutoClosable = CompositeTerminable.create();
    ...
    @Override
    public CompositeTerminable getClosables() {
